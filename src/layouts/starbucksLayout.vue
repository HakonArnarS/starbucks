<template>
  <q-layout view="hHh lpR fff">
    <q-header reveal class="bg-white text-white " height-hint="98">
      <q-toolbar>
        <!-- Starbucks Logo -->
        <a href="/" class="cursor-pointer">
          ...
          >
            <circle
              ...
              style="--darkreader-inline-fill:#eae7e1;"
            ></circle>
            <path
              fill="#006341"
              ...
              data-darkreader-inline-fill=""
              style="--darkreader-inline-fill:#292d30;"
            ></path>
            <g
              fill="#006341"
              data-darkreader-inline-fill=""
        ...
        <!-- Navigation links for larger nav -->
        <div class="lgNavContainer row items-center">
          <ul>
            <li class="listItem"><a href="#">order</a></li>
            <li class="listItem"><a href="#">cards</a></li>
            <li class="listItem"><a href="#">gift</a></li>
          </ul>
          <div>
            <q-btn
              flat
            ...
            <q-btn
              ...
              to="/signin"
            />
            <q-btn unelevated rounded no-caps color="black" label="Join now" />
          </div>
        </div>

        <!-- Hamburger Menu Icon -->
        <q-icon dense flat name="menu" @click="right = !right" class="burger">
        </q-icon>
      </q-toolbar>
    </q-header>

    <q-drawer v-model="right" side="right" overlay class="myDrawer">
      <!-- drawer content -->
      <q-icon name="close" @click="right = !right" />
      <nav class="drawerContent column">
